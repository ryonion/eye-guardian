...
- Subtle blood-vessel progression as the cycle advances
- Exclamation mark appears when 20 minutes is up
- Double left-click resets the timer cycle
- Double-click reset shows a short celebratory spark burst
- Hover over the eye to see elapsed minutes and rests since launch
